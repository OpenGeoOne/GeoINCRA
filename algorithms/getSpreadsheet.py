...
class getSpreadsheet(QgsProcessingAlgorithm):
    ...
    def displayName(self):
        return self.tr('a. Baixar planilha ODS do SIGEF')
    ...
    def shortHelpString(self):
        txt = "Gera uma planilha ODS vazia para preenchimento com os dados exportados com a ferramenta TXT para planilha ODS."
