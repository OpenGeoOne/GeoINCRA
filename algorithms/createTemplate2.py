...
class createTemplate2(QgsProcessingAlgorithm):
	...
	def displayName(self):
		return self.tr('c. GeoRural para Planilha ODS')

	def group(self):
		return self.tr('3. 📋 Preenchimento da Planilha ODS')

	def groupId(self):
		return 'preenchimento_planilha_ods'
	...
	def processAlgorithm(self, parameters, context, feedback):
		...
		if system_os == "Windows":
			...
			path_ods = Path.home() / "AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/GeoINCRA/algorithms/shp/sigef_planilha_modelo_1.4_rc5.ods"
			...
			path_ods = Path.home() / "Library/Application Support/QGIS/QGIS3/profiles/default/python/plugins/GeoINCRA/algorithms/shp/sigef_planilha_modelo_1.4_rc5.ods"
		else:
			path_macro = Path.home() / "Library/Application Support/LibreOffice/4/user/Scripts/python"
			src_macro = Path.home() / "Library/Application Support/QGIS/QGIS3/profiles/default/python/plugins/GeoINCRA/algorithms/shp/macro.py"
			path_ods = Path.home() / "Library/Application Support/QGIS/QGIS3/profiles/default/python/plugins/GeoINCRA/algorithms/shp/sigef_planilha_modelo_1.4_rc5.ods"
